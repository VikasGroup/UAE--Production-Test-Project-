...
Examples:
    ...
    |testvikasretail@yopmail.com|T@stpw120 |https://www.qn-uae.ae/en|
   	|HD812553                   |testpw    |https://www.qn-uae.ae/en|
...
Examples:
    ...
    #|HD333649|Individual|Mr   |test |vikas|04/10/1985|English|971000000028|osura@vikas.lk|osura@vikas.lk|Test@135|Test@135|test   |test|0000    |F0055603240676|QECTST|Welcome! TEST VIKAS|
...
Examples:
    ...
    |HD812553|Company |Test Company|test |test   |English|971000000002|osura@vikas.lk|osura@vikas.lk|Test@135|Test@135|test   |test|0000    |TESTING0000002|PRDECT|Welcome! TEST COMPANY|
...
Examples:
    ...
    |HD812553|Mr   |test |vikasRC|04/10/1985|English|971000000003|osura@vikas.lk|osura@vikas.lk|Test@135|Test@135|test   |test|0000    |Welcome! TEST VIKASRC|
